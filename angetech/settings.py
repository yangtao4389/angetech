"""
Django settings for angetech project.
...
import os
import configparser
from tools.common.iniphaser import IniPhaser
...
WSGI_APPLICATION = 'angetech.wsgi.application'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'backupCount': 1,
            'filename': os.path.join(LOG_DIR, "angetech.log"),
        },
    },
    'loggers': {
        'django.request': {
